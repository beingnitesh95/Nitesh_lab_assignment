...
public class EmployeeDaoMapImpl implements EmployeeDao {
	...
	static {
		empMap.put(++counter, new Employee(counter, "Nitesh", "IT" ,20000));
		empMap.put(++counter, new Employee(counter, "Rahul", "IT" ,30000));
		empMap.put(++counter, new Employee(counter, "Dilip", "IT" ,5000));
	}
